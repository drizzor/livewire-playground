                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <div class="max-w-lg flex rounded-md shadow-sm">
                        ...
                        <input wire:model="username" id="username"
                            class="flex-1 py-3 pl-2 form-input block w-full rounded-none border border-l-0 border-gray-300 rounded-r-md transition duration-150 ease-in-out sm:text-sm sm:leading-5" />
                    </div>
                ...
                <div class="mt-1 sm:mt-0 sm:col-span-2">
                    <div class="max-w-lg flex rounded-md shadow-sm">
                        <textarea wire:model="about" id="about" rows="3"
                            class="form-textarea block py-3 pl-2 w-full transition duration-150 ease-in-out sm:text-sm sm:leading-5"></textarea>
                    </div>
                    @error('about') <div class="mt-1 text-red-500 text-sm">{{ $message }}</div> @enderror
                    <p class="mt-2 text-sm text-gray-500">Quelque chose à ton propos.</p>
                </div>
            </div>
